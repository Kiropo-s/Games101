...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload &payload)
{
    ...
    for (auto &light : lights)
    {
        ...
        float r2 = l.dot(l);
        Eigen::Vector3f i = light.intensity / r2;
        Eigen::Vector3f ambient = ka.cwiseProduct(amb_light_intensity);
        Eigen::Vector3f diffuse = kd.cwiseProduct(i * std::fmax(0, normal.dot(l.normalized())));
        Eigen::Vector3f specular = ks.cwiseProduct(i * pow(std::fmax(0, normal.dot(h)), p));
